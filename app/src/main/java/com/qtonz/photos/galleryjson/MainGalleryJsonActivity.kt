package com.qtonz.photos.galleryjson
...
import com.qtonz.photos.galleryjson.adapter.FolderViewPagerJsonAdapter
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import kotlinx.coroutines.withContext

class MainGalleryJsonActivity : AppCompatActivity() {

    private lateinit var binding: ActivityDeviceImageBinding
    private lateinit var folderPagerAdapter: FolderViewPagerJsonAdapter
    ...
    private fun setupViewPager() {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            withContext(Dispatchers.Main) {
                folderPagerAdapter =
                    FolderViewPagerJsonAdapter(this@MainGalleryJsonActivity, updatedFolderList)
